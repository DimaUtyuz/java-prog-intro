...
5.  **Модификация** *Дополнительные ходы и ромб*
...
5.  **Модификация** *FlipLow и Bitwise*
...
5.  **Модификация** *GcdLcm и AbsSqrt*
